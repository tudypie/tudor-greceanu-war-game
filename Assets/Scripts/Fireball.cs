...
// Procedural detonation visual: a fireball that blooms then fades, an
// expanding shockwave shell, and a decaying point light, then deletes
// itself. Shared by FunMode's nukes and plane crash impacts — scale it
// with the radius argument (a single airframe is far smaller than a nuke).
// Driven on unscaled time so it still animates during FunMode bullet-time.

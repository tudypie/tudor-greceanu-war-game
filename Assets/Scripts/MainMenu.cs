...
// Front-end menu drawn with IMGUI to match the rest of the project's HUD.
// Play runs the campaign from the intro cutscene. Videos replays any cutscene
// (it returns here when done, via GameFlow.NextSceneOverride). Levels jumps
// straight into a mission. Quit exits the build, or stops Play mode.
public class MainMenu : MonoBehaviour
{
    ...
    // Replay a cutscene, then come straight back to the menu instead of
    // letting it flow on into the campaign.

...
public class PlaneSpawner : MonoBehaviour
{
    ...
    // OneShot squadron done: full count emitted and none still alive.
    ...
    // Heightfield ground Y (no physics layers); float.MinValue if no terrain.
    ...
    bool TryPickSpawnPosition(out Vector3 pos)
    {
        ...
        // Lift above ground + clearance so the shell can't spawn into a hill.
